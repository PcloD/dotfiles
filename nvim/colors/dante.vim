...
hi DiffAdd	term=bold ctermfg=black ctermbg=blue guibg=royalblue2
hi DiffChange	term=bold ctermfg=black ctermbg=darkmagenta guibg=maroon
hi DiffDelete	term=bold cterm=bold ctermfg=black ctermbg=cyan gui=bold guifg=lightblue guibg=cyan4
hi DiffText	term=bold ctermfg=black cterm=bold ctermbg=red gui=bold guibg=red3
...
hi ExtraWhitespace term=bold ctermfg=red
